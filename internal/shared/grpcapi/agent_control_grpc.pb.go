...
const (
	AgentControl_Connect_FullMethodName = "/edgepilot.grpcapi.AgentControl/Connect"
)
...
// All implementations should embed UnimplementedAgentControlServer
// for forward compatibility.
type AgentControlServer interface {
	Connect(grpc.BidiStreamingServer[AgentMessage, ControlMessage]) error
}

// UnimplementedAgentControlServer should be embedded to have
...
var AgentControl_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "edgepilot.grpcapi.AgentControl",
	...
	Metadata: "internal/shared/grpcapi/agent_control.proto",
}
