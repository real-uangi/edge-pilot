...
import { UnifiedLineChart, type ChartSeries } from "../../../shared/components/UnifiedLineChart";
import { EmptyState, ErrorState, LoadingState } from "../../../shared/components/StateBlocks";
import { getErrorMessage } from "../../../shared/lib/api-client";
import { boolLabel, formatAgentLabel, formatBytes, formatDateTime, formatPercent } from "../../../shared/lib/format";
import { systemPerformanceApi } from "../api";
...
export function SystemPerformancePage() {
  ...
  const overviewQuery = useQuery({
    ...
    queryFn: systemPerformanceApi.getOverview,
  ...
  const agentHistoryQuery = useQuery({
    ...
    queryFn: () => systemPerformanceApi.getAgentHistory(selectedAgentID!),
